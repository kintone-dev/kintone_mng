(function () {
  ...
  async function deploy() {
    ...
    console.log(JSON.parse(Object.keys(JSON.stringify(fieldsProd.properties))).length);
    console.log(JSON.parse(Object.keys(JSON.stringify(fieldsDev.properties))).length);
