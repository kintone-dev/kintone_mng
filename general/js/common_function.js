...
function krtSetting() {
	...
	mw.contents.innerHTML = '<p>カーテンレール設定</p>' +
		...
		'<div class="krtInput">開き勝手：<label class="radioLabel">(S)片開き<input type="radio" value="(S)片開き" name="openType" checked></label><label class="radioLabel">(W)両開き<input type="radio" value="(W)両開き" name="openType"></label><select><option>開く方法を選択してください。</option><option>左に開ける</option><option>右に開ける</option></select></div>' +
